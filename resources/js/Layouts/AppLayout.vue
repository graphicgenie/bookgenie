...
const navigation = [
    ...
    { name: 'Balans', href: route('balance-sheet'), icon: ChartPieIcon, current: false },
]
const teams = [
...
const userNavigation = [
    { name: 'Your profile', href: route('profile.show'), method: 'GET' },
    ...
    <div>
        ...
        <div class="lg:pl-72 h-full">
            <div class="sticky top-0 z-40">
                <div
                    class="flex h-16 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 lg:shadow-none"
                >
                    <button
                        type="button"
                            ...
                            <Menu as="div" class="relative">
                                <MenuButton class="-m-1.5 flex items-center p-1.5">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                    <span class="ml-4">{{ $attrs.auth.user.name }}</span>
            ...
            <main class="sm:py-6 lg:py-8 h-full">
